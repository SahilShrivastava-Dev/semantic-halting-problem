...
# Make the backend/ dir importable so `shp` resolves regardless of launch cwd.
...
from shp.providers import list_providers
from shp.agent_workflow import build_graph, run_scenario
from shp.optimize_score import optimize_information_score_weights
